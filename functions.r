...
read_airbnb <- function(){
  df <- read.csv('/home/christopher/airbnb/Airbnb_Texas_Rentals.csv')
...
process_airbnb <- function(df){
  ...
  pos = readLines('/home/christopher/airbnb/positive')
  neg = readLines('/home/christopher/airbnb/negative')
